    ...
    void DesenhaLabel(){
        if (label != "") {
            ...
            case COMPONENTE_CIMA:
                EscreverCentralizada((char*)label.c_str(),x+larg/2,y+alt+5,fonteLabel);
                break;
            case COMPONENTE_CIMADIR:
                EscreverDireita((char*)label.c_str(),x+larg,y+alt+5,fonteLabel);
                break;
            case COMPONENTE_CIMAESQ:
                EscreverEsquerda((char*)label.c_str(),x,y+alt+5,fonteLabel);
                break;
            case COMPONENTE_BAIXO:
                EscreverCentralizada((char*)label.c_str(),x+larg/2,y-30,fonteLabel);
                break;
            case COMPONENTE_BAIXODIR:
                EscreverDireita((char*)label.c_str(),x+larg,y-30,fonteLabel);
                break;
            case COMPONENTE_BAIXOESQ:
                EscreverEsquerda((char*)label.c_str(),x,y-30,fonteLabel);
                break;
            case COMPONENTE_ESQUERDA:
                EscreverDireita((char*)label.c_str(),x-5,y,fonteLabel);
                break;
            case COMPONENTE_DIREITA:
                EscreverEsquerda((char*)label.c_str(),x+larg+5,y,fonteLabel);
                break;
            case COMPONENTE_POSICAO_PERSONALIZADA:
                EscreverEsquerda((char*)label.c_str(),x+labelX,y+labelY,fonteLabel);
            }
        }
    }
...
protected:
    ...
    virtual int PulaLinha(){return 1;};
